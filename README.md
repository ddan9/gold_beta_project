...
- textures online editor: https://minecraft.novaskin.me
...
- beta resource pack (with some right textures): https://drive.usercontent.google.com/download?id=0B8Dcd9MmGvq7MVdaZzFOZksyZTg&export=download
...
- green eyed enderman (1): https://minecraft.novaskin.me/skin/3494166/Enderman-green-eyes
- green eyed enderman (2): https://www.planetminecraft.com/mob-skin/green-eyes-enderman-4988521
- cooked porkchop item: https://minecraft.wiki/images/thumb/Cooked_Porkchop_JE2_BE1.png/32px-Cooked_Porkchop_JE2_BE1.png?75c0f
...
- глянуть конкретно текстуры топа блока травы, вроде как они менялись, но не совсем непонятно каким именно образом
- глянуть в браузере в целом чо там во вкладках
- minecraft items renames log
- mcpe splashes
- mcpe splashes list
- minecraft items names changes
- minecraft items renames log
...
- https://www.google.com/search?q=minecraft+ruby+ore+beta+texture&client=firefox-b-lm&sca_upv=1&uact=5
- https://minecraft-archive.fandom.com/wiki/Ruby
- https://www.planetminecraft.com/texture-packs/tag/ruby/?p=3
...
- можно пройтись по каждому entity и глянуть в вики чо как было при добавлени
- нужно обновить инфу readme и мету
- старое освещение было бесцветным
- minecraft make hand shaking slow
- minecraft make hand animation slow
...
- Updated README
- Updated mcmeta file
- Updated resource pack icon file (custom-made)
- Updated enderman textures and sounds (made it fully like from beta 1.8 pre-release (except particles, sadly))
- Updated sheep shear sound
- Updated and fixed end text and credits
- Updated splahes texts, suppressed
- Updated acacia and big oak leaves
- Updated all wood planks (made it all oak, like in beta)
- Updated colormap for foliage and grass (made it more saturate (not much, for about ~10 points))
- Updated entities right from beta builds
- All chests textures replaced with custom-made beta-like textures (fixed double chest top line + removed 3D locks from front)
- Pig nose is now 2D
- Removed TNT explosion particles (replaced with blank file)
- Moon phases texture replaced with custom-made beta-like texture (actually just made it turning, for more interest)
- Updated cake item texture
- Removed inventory armor slot icons (replaced with blank files)
- Updated more beta sounds (sand, grass, gravel)
- Added lighting colormap
...
- Updated README
- Added game icons
- Added default fixed full language packs
- Added background and disc music
- Added beta sounds: ambient caves/weather/, damage, dig, fire, liquid/water, splash, hurt, doors/chests/gates, portal, minecart, steps, TNT, throwing, etc.
- Lava sound replaced back to release (bcs of terrible sound)
- Added beta sounds: mobs cow, sheep, pig, skeleton, spider, slime, wolf, zombie
- Creeper sound replaced back to release (bcs of terrible sound)
- Added beta splashes from start game screen
- Added end and credits texts
- Added colormaps (fixed)
- Added beta items textures: armor, food, resources, dyes, tools, etc.
- Fixed fireball item texture
- Added beta blocks textures: lava, gravel, netherack, cobblestone, mossed cobblestone
- Furnace texture replaced from alpha/beta back to release (bcs of terrible top)
- Chests textures replaced from alpha/beta back to release (bcs of double chest bug)
- Added beta mobs textures: steve (char), enderman, sheep, pig, cow, chicken
